...
fetch('/cart/add', {\n        method: 'POST',\n        headers: { 'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]') ? document.querySelector('meta[name="csrf-token"]').getAttribute('content') : '', 'Content-Type': 'application/json' },\n        body: JSON.stringify({ pdf_id: pdfId })\n    })
    .then(r => r.json())
    .then(data => {
        if (data.success) {
