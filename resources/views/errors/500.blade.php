...
.error-hero{font-family:'Playfair Display',serif;font-size:5rem;color:#EF4444;margin-bottom:16px;line-height:1;}
...
.error-card{background:linear-gradient(135deg,#FEF2F2 0%,#FEF8F6 100%);border:1.5px solid rgba(239,68,68,.2);border-radius:var(--r-lg);padding:40px 32px;margin-bottom:32px;position:relative;overflow:hidden;}
.error-card::before{content:'';position:absolute;inset:0;background-image:linear-gradient(rgba(239,68,68,.02) 1px,transparent 1px),linear-gradient(90deg,rgba(239,68,68,.02) 1px,transparent 1px);background-size:44px 44px;}
...
<div class="error-container">
  <div class="error-card">
    <div style="position:relative;z-index:1;">
      <div class="error-hero">⚠️</div>
      <h1 class="error-title">500 - Server Error</h1>
      <p class="error-desc">Something went wrong on our end. We&apos;re working to fix it. Please try again later or contact support.</p>
      <div class="error-actions">
        <button class="btn-error" onclick="location.reload()"><i class="bi bi-arrow-clockwise"></i> Try Again</button>
