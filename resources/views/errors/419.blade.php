...
.error-hero{font-family:'Playfair Display',serif;font-size:5rem;color:#F59E0B;margin-bottom:16px;line-height:1;}
...
.error-card{background:linear-gradient(135deg,#FEF3C7 0%,#FFF7ED 100%);border:1.5px solid rgba(245,158,11,.2);border-radius:var(--r-lg);padding:40px 32px;margin-bottom:32px;position:relative;overflow:hidden;}
.error-card::before{content:'';position:absolute;inset:0;background-image:linear-gradient(rgba(245,158,11,.02) 1px,transparent 1px),linear-gradient(90deg,rgba(245,158,11,.02) 1px,transparent 1px);background-size:44px 44px;}
...
<div class="error-container">
  <div class="error-card">
    <div style="position:relative;z-index:1;">
      ...
      <p class="error-desc">The page has expired due to inactivity. Please refresh and try again to continue.</p>
      <div class="error-actions">
        <button class="btn-error" onclick="location.reload()"><i class="bi bi-arrow-clockwise"></i> Refresh Page</button>
