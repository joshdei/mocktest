...
.error-hero{font-family:'Playfair Display',serif;font-size:5rem;color:#6B7280;margin-bottom:16px;line-height:1;}
...
.error-card{background:linear-gradient(135deg,var(--gray-100) 0%,#F8FAFC 100%);border:1.5px solid var(--border);border-radius:var(--r-lg);padding:40px 32px;margin-bottom:32px;position:relative;overflow:hidden;}
.error-card::before{content:'';position:absolute;inset:0;background-image:linear-gradient(rgba(107,114,128,.02) 1px,transparent 1px),linear-gradient(90deg,rgba(107,114,128,.02) 1px,transparent 1px);background-size:44px 44px;}
...
<div class="error-container">
  <div class="error-card">
    <div style="position:relative;z-index:1;">
      ...
      <p class="error-desc">The service is temporarily unavailable. We&apos;re performing maintenance. Please check back soon.</p>
